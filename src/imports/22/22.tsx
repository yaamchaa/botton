...
import svgPaths from "./svg-7bo8i0eskn";
import { useState } from 'react'; 
import imgFrame540 from "./zoomkitchen.png";
import imgFrame541 from "./gashob.png";
import imgFrame542 from "./island.png";
import imgFrame543 from "./zoomtable.png";
import imgRectangle24 from "./Capraia.png";
...
import imgRectangle39 from "./Cammeo.png";
  ...
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[528px] top-[309px] cursor-default">
      <div className="content-stretch flex items-center justify-center relative shrink-0 w-[865px]">
        <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] min-w-px not-italic relative text-[#c1c1c1] text-[30px] tracking-[3px]">
          <p>
            <span className="[word-break:break-word] font-['Gmarket Sans',sans-serif] font-light leading-none not-italic">{`Italy's Number One`}</span>
            <span className="leading-none">{` Marizzi Group - `}</span>
            <span className="[word-break:break-word] font-['Gmarket Sans',sans-serif] font-light leading-none not-italic">Capraia</span>
          </p>
        </div>
      </div>
    </div>
...
function Frame12() {
  return (
    <div className="h-[260px] relative shrink-0 w-[509px]">
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[482px] items-start left-[360px] top-[4381px] w-[1200px]">
      <Frame12 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] left-[401px] not-italic text-[12px] text-black top-[309px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">with downdraft</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[550px] p-[10px] top-[544px]">
      <div className="[word-break:break-word] flex flex-col font-['Gmarket_Sans_TTF:Medium',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[15px] text-black tracking-[1.5px] whitespace-nowrap">
        <p className="leading-none">all in one - hob system</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex h-[850px] items-center justify-between left-[351px] top-[2793px] w-[1200px]">
      ...
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket_Sans_TTF:Medium',sans-serif] justify-center leading-[0] left-[689px] not-italic text-[12px] text-black top-[445px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">{`6mm 슬랩 Book match 조인 `}</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket_Sans_TTF:Medium',sans-serif] justify-center leading-[0] left-0 not-italic text-[12px] text-black top-[34px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">{`Italy's Number One Marizzi Group - Capraia`}</p>
      </div>
    </div>
  );
}
...
export default function Component6() {
  ...
  const thicknessInfo = {
    "6mm": {
      title: "Capraia   IS 1200 TO",
      spec: "L : 3200  W : 1500  Weight : 900",
      price: "5,620,000",
    ...
    "12mm": {
      title: "Capraia   IS 1200 TO",
      spec: "L : 3200  W : 1600  Weight : 1200",
      price: "6,800,000",
