import svgPaths from "./svg-79b6jwby5l";
import { Link, useNavigate } from 'react-router';
import { useState } from 'react'; 
import ScrollToTop from "./ScrollToTop";
import imgFrame540 from "./front.png";
import imgFrame541 from "./side.png";
import imgFrame542 from "./zoomout.png";
import imgFrame543 from "./topview.png";
import imgRectangle24 from "./TITLIS_WHITE.png";
import imgRectangle29 from "./Calacatta_Luxe.png";
import imgRectangle33 from "./Cammeo.png";
...
function Frame11() {
  return (
    <button className="absolute content-stretch cursor-pointer flex items-center justify-center left-[578px] top-[311px]">
      <div className="content-stretch flex items-center justify-center relative shrink-0">
        <div className="[word-break:break-word] flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[#c1c1c1] text-[30px] text-left tracking-[3px] whitespace-nowrap">
          <p>
            <span className="leading-none">{`Minimalism and perfection in `}</span>
            <span className="[word-break:break-word] font-['Gmarket Sans',sans-serif] font-light leading-none not-italic">Special</span>
...
function Frame32() {
  return (
    <button className="absolute content-stretch cursor-pointer flex items-center justify-center left-[578px] top-[2606px]">
      <div className="content-stretch flex items-center justify-center relative shrink-0">
        <div className="[word-break:break-word] flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] not-italic relative shrink-0 text-[#c1c1c1] text-[30px] text-left tracking-[3px] whitespace-nowrap">
          <p>
            <span className="leading-none">{`Minimalism and `}</span>
            <span className="[word-break:break-word] font-['Gmarket Sans',sans-serif] font-light leading-none not-italic">perfection</span>
...
function Frame12() {
  return (
    <div className="h-[600px] relative shrink-0 w-[1200px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[100.02%] left-0 max-w-none top-[-0.26%] w-full" src={imgFrame540} />
      </div>
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="absolute content-stretch flex gap-[10px] h-[520px] items-start left-[360px] top-[2800px] w-[1200px]">
      <Frame12 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket Sans',sans-serif] font-light 
                        justify-center leading-[0] left-[800px] not-italic text-[15px] text-white top-[550px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">Minimalism and perfection in every detail</p>
      </div>
    </div>
  );
}
...
function Frame31() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[996px] top-[854px]">
      <p className="[word-break:break-word] font-['Inter:Regular','Noto_Sans_KR:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[#b7b7b7] text-[10px] text-right whitespace-nowrap">*싱크상판 디자인에 따라 가격은 변동 됩니다.</p>
    </div>
  );
}
...
function Frame34() {
  return <div className="absolute h-[15px] left-[3700px] top-[519px] w-[224px]" />;
}

function Frame14() {
  return (
    <div className="h-[625px] overflow-clip relative shrink-0 w-[1200px]">
...
function Frame35() {
  return (
    <div className="absolute content-stretch flex items-center justify-center left-[0px] p-[10px] top-[0px]">
      <div className="[word-break:break-word] flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] 
                        not-italic relative shrink-0 text-[15px] text-black tracking-[1.5px] whitespace-nowrap">
        <p className="leading-none">Minimalism and perfection in every detail</p>
      </div>
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute content-stretch flex gap-[40px] h-[800px] items-center justify-end left-[360px] top-[3600px] w-[1200px]">
      <Frame14 />
      <Frame35 />
    </div>
  );
...
function Frame18() {
  return (
    <div className="h-[689px] relative shrink-0 w-[511px]">
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <img alt="" className="absolute h-[43.82%] left-0 max-w-none top-[-0.38%] w-full" src={imgFrame543} />
      </div>
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] content-stretch flex h-[850px] items-center justify-between left-[351px] top-[4500px] w-[1200px]">
      <Frame17 />
      <Frame18 />
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] left-[689px] not-italic text-[12px] text-black top-[445px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">{`A taste of luxury`}</p>
      </div>
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] left-0 not-italic text-[12px] text-black top-[34px] tracking-[0.6px] whitespace-nowrap">
        <p className="leading-[1.5]">{`Different widths, greater possibilities`}</p>
      </div>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="absolute h-[33px] left-[444px] top-[22px] w-[227px]">
      <div className="-translate-y-1/2 [word-break:break-word] absolute flex flex-col font-['Gmarket Sans',sans-serif] font-light justify-center leading-[0] left-0 not-italic text-[#b7b7b7] text-[15px] top-[16.5px] tracking-[0.75px] whitespace-nowrap">
...
function Frame() {
  return (
    <div className="[word-break:break-word] absolute font-['Gmarket Sans',sans-serif] font-light h-[18px] leading-[0] left-[444px] not-italic text-[#b7b7b7] text-[12px] top-[4px] w-[532px] whitespace-nowrap">
...
function Component() {
  return (
    <div className="absolute bg-white h-[550px] left-0 overflow-auto top-[5500px] w-[1920px]" data-name="푸터 바탕">
      <Frame8 />
    </div>
  );
}
...
export default function Component6() {
  ...
  const [CammeoThickness, setCammeoThickness] = useState<"6mm" | "12mm">("6mm");
  ...
  const thicknessInfo = {
    ...
    "6mm": {
      title: "TITLIS WHITE   IS650 SH",
      spec: "L : 0  W : 0  Height : 0",
      price: "0",
      size: "Size : 0 x 0   T : 6mm",
      brand: "Brand : INOL",
...
>
  ...
  data-name="적용가능 자재 Niagara"
  onMouseLeave={() => setCammeoThickness("6mm")}
       onClick={() => navigate("/projects/Cammeo")}
>
  <div className="absolute inset-0 rounded-[15px]">
    <img
      alt=""
    ...
    <div className="absolute top-12 right-4 z-10 text-right opacity-0 -translate-y-1 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
      <p className="flex items-start justify-end gap-1 leading-none text-white">
        <span className="relative top-[2px] text-[11px] font-light">￦</span>
        <span className="text-[15px] font-midium tracking-[0.02em]">
          {CammeoInfo[CammeoThickness].price}
        </span>
      </p>
    </div>

    <div className="absolute bottom-4 right-4 z-10 text-right text-white opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
      <p className="text-[13px] font-medium tracking-[0.12em]">OC09 Cammeo   FE640 IS</p>
      <div className="mt-3 space-y-1 text-[11px] leading-[1.5] text-white/90">
        <p>{CammeoInfo[CammeoThickness].size}</p>
        <p>{CammeoInfo[CammeoThickness].brand}</p>
        <p>{CammeoInfo[CammeoThickness].pattern}</p>
        <p>{CammeoInfo[CammeoThickness].finish}</p>
      </div>
    </div>
  </div>
  ...
  <div
    className="absolute inset-[10.64%_73.76%_73.05%_9.93%] cursor-pointer"
    onMouseEnter={() => setCammeoThickness("6mm")}
    onClick={(e) => e.stopPropagation()}
  >
    <svg
      className={`absolute block inset-0 size-full transition-opacity duration-200 ${
        CammeoThickness === "6mm" ? "opacity-100" : "opacity-55"
      }`}
      fill="none"
      preserveAspectRatio="none"
      viewBox="0 0 46 46"
  ...
  <div
    className="absolute inset-[34.4%_73.76%_49.29%_9.93%] cursor-pointer"
    onMouseEnter={() => setCammeoThickness("12mm")}
    onClick={(e) => e.stopPropagation()}
  >
    <svg
      className={`absolute block inset-0 size-full transition-opacity duration-200 ${
        CammeoThickness === "12mm" ? "opacity-100" : "opacity-55"
      }`}
      fill="none"
      preserveAspectRatio="none"
      viewBox="0 0 46 46"
...
>
  <div className="absolute inset-0 rounded-[15px]">
    ...
    <div className="absolute bottom-4 right-4 z-10 text-right text-white opacity-0 translate-y-2 transition-all duration-300 group-hover:opacity-100 group-hover:translate-y-0">
      <p className="text-[13px] font-medium tracking-[0.12em]">Capraia   IS 1200 TO</p>
      <div className="mt-3 space-y-1 text-[11px] leading-[1.5] text-white/90">
