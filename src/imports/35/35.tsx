  ...
  return (
    ...
    >
      <div className="content-stretch flex items-center justify-center relative shrink-0">
        <p className="leading-none">SINK DESIGN</p>
      </div>
    </div>
  );
}
    ...
    >
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] tracking-[1.9px]">
        <p className="leading-none">
          {isHovered ? "싱크대 상판 디자인" : "KITCHEN TOP TABLE DESIGN"}
        </p>
      </div>
...
function BobSink() {
  return (
    <div className="content-between flex flex-wrap items-start pl-[188px] relative shrink-0 w-[1575px]" data-name="Bob' sink">
      <Frame />
    </div>
  );
}
  ...
  return (
    <div className="fixed bg-white/75 backdrop-blur-md content-stretch flex items-center justify-between left-0 px-[360px] py-[20px] top-0 w-full z-50">
      <div
        ...
        className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col gap-[10px] h-[62px] 
        items-start justify-center overflow-clip px-[35px] shrink-0 sticky top-0 w-[140px] cursor-pointer hover:opacity-70 transition-opacity"
        data-name="메뉴 이동 버튼"
      >
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3-5.">
