import svgPaths from "./svg-tl6ltd7xv8";
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] tracking-[1.9px]">
        <p className="leading-none">KITCHEN TOP TABLE DESIGN</p>
      </div>
  ...
  return (
    <div className="[word-break:break-word] content-stretch flex font-['Gmarket Sans',sans-serif] font-light gap-[300px] items-start leading-[0] not-italic relative shrink-0 tracking-[1.9px] w-[1199px] whitespace-nowrap">
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black">
        <p className="leading-none whitespace-pre">{`Sink Top Table Design  costs`}</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[#9a9a9a] text-[0px]">
        <p className="whitespace-pre">
          <span className="leading-none text-[19px]">350</span>
          <span className="leading-none text-[#9a9a9a] text-[19px]">{`,000 `}</span>
          <span className="leading-none text-[#9a9a9a] text-[11px]">\</span>
          <span className="leading-none text-[#9a9a9a] text-[19px]">{`  /  `}</span>
          <span className="leading-none text-[19px]">M</span>
        </p>
      </div>
    </div>
  );
...
function Frame9() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col font-['Gmarket Sans',sans-serif] font-light gap-[20px] items-start leading-[0] not-italic relative shrink-0 w-[1199px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none">{`2D-visualization.  / 2`}</span>
          <span className="leading-none text-[#9a9a9a]">D 이미지 시뮬레이션</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none">{`Working documentation  /  `}</span>
          <span className="leading-none text-[#9a9a9a]">작업문서 ( 설계도, 자재 및 기기 사양 )</span>
        </p>
      </div>
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[#9a9a9a] text-[19px] tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none text-black">{`Kitchen Top Table plan  /`}</span>
          <span className="leading-none">{`  설계`}</span>
          <span className="leading-none text-[#9a9a9a]">도</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none">{`Top Table section drawing  /  `}</span>
          <span className="leading-none text-[#9a9a9a]">단면도</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[0px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none text-[19px]">{`Plan of light groups,  /  `}</span>
          <span className="leading-none text-[#9a9a9a] text-[19px]">조명계획 ( 도플러</span>
          <span className="leading-none text-[#9a9a9a] text-[12px]">{`&`}</span>
          <span className="leading-none text-[#9a9a9a] text-[19px]">센서 스위치, 콘센트 계획 )</span>
          <span className="leading-none text-[19px]">{` `}</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
          <span className="leading-none">{`Specification of household appliances & sink  /  `}</span>
          <span className="leading-none text-[#9a9a9a]">가전제품 및 싱크볼 추천 사양</span>
        </p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] text-black tracking-[1.9px]">
        <p className="whitespace-pre">
...
function Frame10() {
  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center relative shrink-0 text-[19px] tracking-[1.9px]">
        <p className="leading-none">FULL SERVICE KITCHEN DESIGN</p>
      </div>
      <div className="flex flex-col justify-center relative shrink-0 text-[30px] tracking-[3px]">
        <p className="leading-none">+</p>
      </div>
...
function BobSink() {
  return (
    <div className="content-between flex flex-wrap items-start pl-[188px] relative shrink-0 w-[1535px]" data-name="Bob' sink">
      <Frame />
    </div>
  );
}
...
function Frame1290Variant() {
  return (
    <div className="absolute bg-white content-stretch flex flex-col gap-[174px] h-[1772px] items-center left-[-2px] pb-[20px] pt-[320px] top-[4px] w-[1920px]" data-name="Frame 1290/Variant2">
      <Frame11 />
      <BobSink />
    </div>
  );
...
export default function Component() {
  return (
    <div className="bg-white relative size-full" data-name="3-5(1).">
      <Frame1290Variant />
