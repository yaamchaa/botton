import svgPaths from "./svg-s448ldprji";
...
function Frame7() {
  ...
  return (
    <div
      ...
      className="[word-break:break-word] content-stretch flex font-['Gmarket Sans',sans-serif] font-light gap-[786px] items-center justify-center leading-[0] not-italic relative shrink-0 text-black whitespace-nowrap cursor-pointer hover:opacity-70 transition-opacity duration-500"
    >
    ...
    <div className="[word-break:break-word] content-stretch flex font-['Gmarket Sans',sans-serif] font-light gap-[300px] items-start leading-[0] not-italic relative shrink-0 tracking-[1.9px] w-[1199px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center relative shrink-0 text-[#9a9a9a] text-[0px]">
        <p className="whitespace-pre">
          <span className="leading-none text-[19px]">25</span>
...
function Frame1290Variant({ className }: { className?: string }) {
  return (
    <div className={className || "absolute bg-white content-stretch flex flex-col gap-[174px] h-[1772px] items-center left-[-2px] pb-[20px] pt-[320px] top-[4px] w-[1920px]"} data-name="Frame 1290/Variant2">
      <Frame11 />
      <BobSink />
    </div>
  );
...
function Group1() {
  return <div className="absolute contents left-[893px] top-[42px]"></div>;
}

function Frame1() {
  return <div className="absolute h-[47px] left-0 top-0 w-[135px]"></div>;
}
    ...
    <div className="absolute content-stretch flex items-center justify-center left-[11px] top-[12px]">
      <div className="[word-break:break-word] flex flex-col font-['MS_Gothic:Regular',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#e5e5e5] text-[0px] whitespace-nowrap">
        <p>
          ...
          <span
            className="[word-break:break-word] font-['Noto_Sans:Display_Regular',sans-serif] font-normal leading-[normal] text-[#e5e5e5] text-[15px]"
...
function Frame15() {
  ...
  return (
    <div className="fixed bg-white/75 backdrop-blur-md content-stretch flex items-center justify-between left-0 px-[360px] py-[20px] top-0 w-full z-50">
      <div onClick={() => navigate('/menu')} className="bg-[rgba(255,255,255,0)] content-stretch flex flex-col gap-[10px] h-[62px] 
        items-start justify-center overflow-clip px-[35px] shrink-0 sticky top-0 w-[140px] cursor-pointer hover:opacity-70 transition-opacity" data-name="메뉴 이동 버튼">
      ...
      <Link to="/website" className="backdrop-blur-[5px] h-[47px] relative shrink-0 w-[135px] cursor-pointer rounded-full hover:rounded-full 
                                     hover:bg-gray-200 transition-all duration-800" data-name="웹사이트 이동버튼">
        <Frame3 />
        <Frame4 />
      </Link>
    </div>
...
export default function Component() {
  ...
  <>
    <style>{`
      ...
      .page-fade-in {
        animation: pageFadeIn 700ms ease forwards;
      }
    `}</style>

    <Frame15 />

    <div className="bg-white relative size-full page-fade-in" data-name="3-4(1).">
      <Frame1290Variant />
      <Group1 />
